...
class ContentMergeServiceTest {

    private final ContentMergeService contentMergeService = new ContentMergeService();
    ...
    void insertPlaceholdersIntoContentInsertsAfterMatchingHeadingAndSkipsCover() {
        ...
        String result = contentMergeService.insertPlaceholdersIntoContent(
    ...
    void mergeImagesIntoContentPrependsCoverImage() {
        ...
        String result = contentMergeService.mergeImagesIntoContent(content, List.of(cover));
