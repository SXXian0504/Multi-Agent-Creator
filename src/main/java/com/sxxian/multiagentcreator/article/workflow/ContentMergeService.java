...
public class ContentMergeService implements NodeAction {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        log.info("ContentMergeService 寮€濮嬫墽琛? 姝ｆ枃闀垮害={}, 鍥剧墖鏁伴噺={}", content.length(), images.size());

        String fullContent = mergeImagesIntoContent(content, images, traces);

        log.info("ContentMergeService 鎵ц瀹屾垚: 瀹屾暣鍐呭闀垮害={}", fullContent.length());
