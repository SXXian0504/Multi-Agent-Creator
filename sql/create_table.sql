...
(
    ...
    image_review_results json                          null comment 'Image review results',
    image_execution_traces json                        null comment 'Image execution traces',
    outline_image_intents json                         null comment 'User image intents before outline confirmation',
    pending_image_revisions json                       null comment 'Pending or historical image revision candidates',
